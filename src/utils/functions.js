import { EXERCISES, SCHEMES, TEMPOS, WORKOUTS } from "./fitness";
const exercises = exercisesFlattener(EXERCISES)

export function generateWorkout(args) {
    const { muscleGroups, workoutType: workout, goal } = args
    ...
    if (workout === "individual") {
        listOfMuscles = muscleGroups;
    } else {
        listOfMuscles = WORKOUTS[workout][muscleGroups[0]];
    }
